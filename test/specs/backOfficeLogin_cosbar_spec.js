...
describe('backOffice validation', () => {
    ...
    it('BackOffice login cosbar page', async () =>  {
    // open the backOfficePage page
    await BackOfficePage.openBackOfficePage(RetailerList.cosbar);
    await expect(browser).toHaveUrlContaining("https://" + RetailerList.cosbar + "-qa05.salesfloor.net");
